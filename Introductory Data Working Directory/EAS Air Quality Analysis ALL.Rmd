...
Download the full time series from the sensor(s) you're interested in from the QuantAQ website.
...
-   Store all the QuantAQ data in the folder called ./data/quant_aq, which is
    a subfolder in "/data" folder of this workspace.
-   Store the meteorology data in the ./data/met folder in this workspace.
...
data_file <- "./data/quant_aq/MOD-00415-Hartford.csv"  # Data file path for AQ data
...
#timePlot(aq_df_filtered, pollutant = c("pm1", "pm25", "pm10"), scales= "free")
...
met_file <- "data/met/hartford_met.csv"
